      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage verification flow, user governance, and operational health.</p>
          </div>
        ...
        <div className="flex gap-4 border-b border-gray-200 mb-6">
          ...
          >
            Verification Queue ({pendingApplicants.length})
          </button>
          <button 
        ...
        {activeTab === 'statistics' && (
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
              <h3 className="text-lg font-bold mb-4 text-gray-800">Operational Tools</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  onClick={() => router.push('/admin/training')}
                  className="p-4 text-left border border-blue-200 bg-blue-50 rounded-lg hover:bg-blue-100 transition"
                >
                  <p className="font-semibold text-blue-900">Training Curator</p>
                  <p className="text-sm text-blue-700">Prepare record batches and update training statuses.</p>
                </button>
                <button
                  onClick={() => router.push('/admin/ai-models')}
                  className="p-4 text-left border border-purple-200 bg-purple-50 rounded-lg hover:bg-purple-100 transition"
                >
                  <p className="font-semibold text-purple-900">AI Control Center</p>
                  <p className="text-sm text-purple-700">Configure and trigger training, then review model history.</p>
                </button>
              </div>
            </div>
          </div>
